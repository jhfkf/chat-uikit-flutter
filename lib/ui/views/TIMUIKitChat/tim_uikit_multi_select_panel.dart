...
class MultiSelectPanel extends TIMUIKitStatelessWidget {
  ...
  _handleForwardMessageWide(BuildContext context, bool isMergerForward,
    ...
    V2TimMessage? message =
        model.multiSelectedMessageList.firstWhereOrNull((e) {
      if (e.customElem != null) {
        CustomMessageExtEntity? extEntity =
            CustomMessageUtils.messageCustomExt(e);
        if (extEntity != null) {
          return extEntity.isRedPacket;
        }
      }
      return false;
    });
    if (message != null) {
      ToastUtils.toast("红包消息不支持转发");
      return;
    }
